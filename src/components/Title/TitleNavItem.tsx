  ...
  return (
    <li className="flex ">
      <Link
        ...
        duration={600}
        onClick={onClick}
        className={`group  cursor-pointer whitespace-nowrap rounded-full border-2 px-2 py-2 lg:border-none border-${isActive ? "primary" : "light-text"
          } text-${isActive ? "primary" : "light-text"
          } transition duration-300 after:text-primary`}
      >
        {label}
        <span
